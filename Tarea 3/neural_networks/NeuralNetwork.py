...
class NeuralNetwork(object):
    ...
    def getWeight(self, numberOfLayer, numberOfNeuron, numberOfWeight):
        """Return a weight from the current neural network according to a position."""
        return self.firstLayer.getWeightFromNeuron(numberOfLayer, numberOfNeuron, numberOfWeight)

    def getNeuron(self, numberOfLayer, numberOfNeuron):
        """Return a neuron from the current neural network according to a position."""
        return self.firstLayer.getNeuronFromLayer(numberOfLayer, numberOfNeuron)

    def setWeight(self, weight, numberOfLayer, numberOfNeuron, numberOfWeight):
        """Set a weight from the current neural network according to a position."""
        self.firstLayer.setWeightFromNeuron(weight, numberOfLayer, numberOfNeuron, numberOfWeight)

    def setNeuron(self, neuron, numberOfLayer, numberOfNeuron):
        """Set a neuron from the current neural network according to a position."""
        self.firstLayer.setNeuronFromLayer(neuron, numberOfLayer, numberOfNeuron)